...
public class Prompts {
  ...
  public static final PromptTemplate INTERVIEWER_SYSTEM_PROMPT = new PromptTemplate("""
      ...
      **Финальный отзыв:**
      - Закончив интервью (либо после последнего вопроса, либо по команде завершения), выведи на первой строке фразу: «Интервью завершено» (это служебная фраза, чтобы можно было отловить момент завершения интервью, **ОБЯЗАТЕЛЬНО ЕЕ ВЫВЕДИ!**).
